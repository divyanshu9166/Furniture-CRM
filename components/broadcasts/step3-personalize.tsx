...
export function Step3Personalize({
  ...
  // Load user's custom fields and a representative contact for the
  ...
  // A placeholder is unmapped if the user has not picked either a
  // static value or a field/custom-field source.
    ...
    <div className="space-y-6">
            ...
            return (
              ...
              >
                <div className="mb-3 flex items-center gap-2">
                  <span className="inline-flex items-center rounded-md bg-accent-light px-2 py-0.5 text-xs font-mono font-medium text-accent">
                    {placeholder}
                  </span>
                </div>
      ...
      <div className="glass-card p-4">
        <div className="mb-3 flex items-center gap-2">
          ...
          <span className="text-xs text-muted opacity-60">({previewLabel})</span>
          {loadingPreview && (
