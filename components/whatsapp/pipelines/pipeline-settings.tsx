...
export function PipelineSettings({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-surface border-border max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          ...
          <>
            <div className="grid gap-4 py-2">
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className="border-border bg-surface-light text-sm text-foreground"
                    onKeyDown={(e) => {
                  ...
                  <Button
                    ...
                    className="shrink-0 border-border bg-transparent text-foreground hover:bg-surface-light"
                  >
              ...
              <Button
                ...
                className="w-full border-border bg-transparent text-foreground hover:bg-surface-light"
              >
                <Plus className="mr-1 h-3 w-3" />
            ...
            <DialogFooter className="border-border bg-surface">
              <Button
                variant="destructive"
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-0 top-6 z-20 flex flex-wrap gap-1 rounded-lg border border-border bg-surface p-2 shadow-lg w-36">
            {colors.map((c) => (
              <button
                key={c}
                type="button"
