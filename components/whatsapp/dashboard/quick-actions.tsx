      ...
      {ACTIONS.map((a) => {
        ...
        return (
          <Link
            key={a.href}
            href={a.href}
            className="group flex items-center gap-3 rounded-xl border border-border bg-surface px-4 py-3 shadow-card transition-colors hover:border-border-light hover:bg-surface-hover"
          >
            <div className={`flex h-9 w-9 items-center justify-center rounded-lg bg-surface-light ${a.tint}`}>
